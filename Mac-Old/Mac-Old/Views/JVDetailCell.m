...
- (NSString *)accessibilityValueDescription
{
	...
	NSString *statusText = (!_statusImage && _statusNumber) ? [NSString localizedStringWithFormat:NSLocalizedString(@"%lu items", nil), _statusNumber]: nil;
	NSString *importantStatusText = (!_statusImage && _importantStatusNumber) ? [NSString localizedStringWithFormat:NSLocalizedString(@"%lu important items", nil), _importantStatusNumber]: nil;

...
- (void) applicationDidFinishLaunching:(NSNotification *) notification {
	...
	if (![[NSUserDefaults standardUserDefaults] boolForKey:@"JVAskedToAllowAnalytics"]) {
		NSAlert *alert = [[NSAlert alloc] init];
		alert.messageText = NSLocalizedString(@"Allow analytics to be sent?", @"Allow analytics to be sent? message text.");
		alert.informativeText = NSLocalizedString(@"To help us know what to improve on, Colloquy can send back information about your current configuration. The data sent back will not contain any identifiable information. ", @"To help us know what to improve on, Colloquy can send back information about your current configuration. The data sent back will not contain any identifiable information message text");
		alert.alertStyle = NSAlertStyleInformational;
		[alert addButtonWithTitle:NSLocalizedString(@"Send", @"Send button title")];
		[alert addButtonWithTitle:NSLocalizedString(@"Don't send", @"Don't send button title")];
		NSModalResponse response = [alert runModal];

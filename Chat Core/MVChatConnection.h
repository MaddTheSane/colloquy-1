...
typedef NS_ENUM(OSType, MVChatConnectionType) {
	MVChatConnectionUnsupportedType NS_SWIFT_NAME(unsupported) = 0,
	MVChatConnectionICBType NS_SWIFT_NAME(ICB) = 'icbC',
	MVChatConnectionIRCType NS_SWIFT_NAME(IRC) = 'ircC',
	MVChatConnectionSILCType NS_SWIFT_NAME(SILC) = 'silC',
	MVChatConnectionXMPPType NS_SWIFT_NAME(XMPP) = 'xmpC'
};

typedef NS_ENUM(OSType, MVChatConnectionStatus) {
	MVChatConnectionDisconnectedStatus NS_SWIFT_NAME(disconnected) = 'disC',
	MVChatConnectionServerDisconnectedStatus NS_SWIFT_NAME(serverDisconnected) = 'sdsC',
	MVChatConnectionConnectingStatus NS_SWIFT_NAME(connecting) = 'conG',
	MVChatConnectionConnectedStatus NS_SWIFT_NAME(connected) = 'conD',
	MVChatConnectionSuspendedStatus NS_SWIFT_NAME(suspended) = 'susP'
};

typedef NS_ENUM(OSType, MVChatConnectionProxy) {
	MVChatConnectionNoProxy NS_SWIFT_NAME(none) = 'nonE',
	MVChatConnectionHTTPProxy NS_SWIFT_NAME(HTTP) = 'httP',
	MVChatConnectionHTTPSProxy NS_SWIFT_NAME(HTTPS) = 'htpS',
	MVChatConnectionSOCKS4Proxy NS_SWIFT_NAME(SOCKS4) = 'soK4',
	MVChatConnectionSOCKS5Proxy NS_SWIFT_NAME(SOCKS5) = 'soK5'
};

typedef NS_ENUM(OSType, MVChatConnectionBouncer) {
	MVChatConnectionNoBouncer NS_SWIFT_NAME(none) = 'nonB',
	MVChatConnectionGenericBouncer NS_SWIFT_NAME(generic) = 'gbnC',
	MVChatConnectionColloquyBouncer NS_SWIFT_NAME(colloquy) = 'cbnC'
};

typedef NS_ENUM(OSType, MVChatConnectionPublicKeyType) {
	MVChatConnectionServerPublicKeyType NS_SWIFT_NAME(server) = 'serV',
	MVChatConnectionClientPublicKeyType NS_SWIFT_NAME(client) = 'clnT'
};

typedef NS_ENUM(OSType, MVChatMessageFormat) {
	MVChatConnectionDefaultMessageFormat NS_SWIFT_NAME(connectionDefaunt) = 'cDtF',
	MVChatNoMessageFormat NS_SWIFT_NAME(none) = 'nOcF',
	MVChatWindowsIRCMessageFormat NS_SWIFT_NAME(windowsIRC) = 'mIrF',
	MVChatCTCPTwoMessageFormat NS_SWIFT_NAME(CTCPTwo) = 'ct2F',
	MVChatJSONMessageFormat NS_SWIFT_NAME(JSON) = 'jsoN'
};
...
typedef NS_ERROR_ENUM(MVChatConnectionErrorDomain, MVChatConnectionError) {
	MVChatConnectionUnknownError NS_SWIFT_NAME(unknown) = -1,
	MVChatConnectionNoSuchUserError NS_SWIFT_NAME(noSuchUser) = -2,
	MVChatConnectionNoSuchRoomError NS_SWIFT_NAME(noSuchRoom) = -3,
	MVChatConnectionNoSuchServerError NS_SWIFT_NAME(noSuchServer) = -4,
	MVChatConnectionCantSendToRoomError NS_SWIFT_NAME(cantSendToRoom) = -5,
	MVChatConnectionCantChangeNickError NS_SWIFT_NAME(cantChangeNick) = -6,
	MVChatConnectionNotInRoomError NS_SWIFT_NAME(notInRoom) = -7,
	MVChatConnectionUserNotInRoomError NS_SWIFT_NAME(userNotInRoom) = -8,
	MVChatConnectionRoomIsFullError NS_SWIFT_NAME(roomIsFull) = -9,
	MVChatConnectionInviteOnlyRoomError NS_SWIFT_NAME(inviteOnlyRoom) = -10,
	MVChatConnectionRoomPasswordIncorrectError NS_SWIFT_NAME(roomPasswordIncorrect) = -11,
	MVChatConnectionBannedFromRoomError NS_SWIFT_NAME(bannedFromRoom) = -12,
	MVChatConnectionUnknownCommandError NS_SWIFT_NAME(unknownCommand) = -13,
	MVChatConnectionErroneusNicknameError NS_SWIFT_NAME(erroneusNickname) = -14,
	MVChatConnectionBannedFromServerError NS_SWIFT_NAME(bannedFromServer) = -15,
	MVChatConnectionServerPasswordIncorrectError NS_SWIFT_NAME(serverPasswordIncorrect) = -16,
	MVChatConnectionProtocolError NS_SWIFT_NAME(protocol) = -17,
	MVChatConnectionOutOfBricksError NS_SWIFT_NAME(outOfBricks) = -18,
	MVChatConnectionCantChangeUsedNickError NS_SWIFT_NAME(cantChangeUsedNick) = -19,
	MVChatConnectionIdentifyToJoinRoomError NS_SWIFT_NAME(identifyToJoinRoom) = -20,
	MVChatConnectionRoomDoesNotSupportModesError NS_SWIFT_NAME(roomDoesNotSupportModes) = -21,
	MVChatConnectionNickChangedByServicesError NS_SWIFT_NAME(nickChangedByServices) = -22,
	MVChatConnectionServicesDownError NS_SWIFT_NAME(servicesDown) = -23,
	MVChatConnectionTLSError NS_SWIFT_NAME(TLS) = -24
};
...
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionWatchFeature;

// IRC3v1 Required
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionSASLFeature;
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionMultipleNicknamePrefixFeature;

// IRC3v1 Optional
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionAccountNotifyFeature;
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionAwayNotifyFeature;
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionExtendedJoinFeature;
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionTLSFeature;

// IRC3v2 Required
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionMessageTagsFeature;
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionMonitorFeature;

// IRC3v2 Optional
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionServerTimeFeature;
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionBatchFeature;
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionUserhostInNamesFeature;
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionChghostFeature;

COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionAccountTagFeature;
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionCapNotifyFeature;
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionInviteFeature;
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionEchoMessageFeature;

// IRC3v3 Prototypes
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionSTSFeature;

// InspIRCd Enhancements
COLLOQUY_EXPORT extern MVChatConnectionFeatures const MVChatConnectionNamesxFeature;

// Notifications
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionWillConnectNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionDidConnectNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionDidNotConnectNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionWillDisconnectNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionDidDisconnectNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionGotErrorNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionErrorNotification;

COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionNeedTLSPeerTrustFeedbackNotification; // used when connecting
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionNeedNicknamePasswordNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionNeedServerPasswordNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionNeedCertificatePasswordNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionNeedPublicKeyVerificationNotification;

COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionGotBeepNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionGotImportantMessageNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionGotInformationalMessageNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionGotRawMessageNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionGotPrivateMessageNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionChatRoomListUpdatedNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionBatchUpdatesWillBeginNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionBatchUpdatesDidEndNotification;

COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionSelfAwayStatusChangedNotification;

COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionNicknameAcceptedNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionNicknameRejectedNotification;

COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionDidIdentifyWithServicesNotification;

COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionSubcodeRequestNotification;
COLLOQUY_EXPORT extern NSNotificationName const MVChatConnectionSubcodeReplyNotification;
